...
<div class="bodyWrapper"><!-- DIV wrapper required for mmenu to work properly and some contentBlocks --><header role="banner"><div class="topBar-container topBar-container--fixed"><div top-bar><ul class="title-area"><li class="name"><a href="/"><img class="title-area-logo--hover" src="/assets/logos/bc-logo-bright.svg" alt="bc-logo-dark" /><img class="title-area-logo" src="/assets/logos/bc-logo-dark.svg" alt="bc-logo-dark" /></a></li><li toggle-top-bar class="menu-icon"><a href="#mobile-nav"><i class="icon icon-bcburger"></i><span class="text">Menu</span></a></li></ul><section class="top-bar-section"><ul class="menuItems"><li class="toggleDropdown toggleDropdown--1 "><a href="#" title="Solutions" >Solutions</a></li><li class="toggleDropdown toggleDropdown--2 "><a href="#" title="Sell everywhere" >Sell everywhere</a></li><li class=" "><a href="/features/" title="Features" >Features</a></li><li class=" "><a href="/showcase/" title="Clients" >Clients</a></li><li class=" "><a href="/pricing/" title="Pricing" >Pricing</a></li><li class="toggleDropdown toggleDropdown--6 "><a href="#" title="Resources" >Resources</a></li></ul></section><div class="top-bar-actions"><div class="optional top-bar-actions--login"><a href="/login/">Log In</a></div><div class="optional"><button class="button button--action button--small gtm_trial_start" trial-modal-v2="15-day-free-trial-modal-v2">Get Started</button></div></div></div><div class="topBar-dropdown topBar-dropdown--1"><div class="topBar-dropdown-navSection topBar-dropdown-navSection--main "><ul class="topBar-dropdown-nav"><li class="topBar-dropdown-nav-item"><a href="/enterprise-ecommerce-solution/" title="/enterprise-ecommerce-solution/">
                                        Enterprise
                                        
                                                                                    <span class="link-description">Superior reliability and advanced tools for running your whole business</span></a></li><li class="topBar-dropdown-nav-item"><a href="/ecommerce-solutions/" title="/ecommerce-solutions/">
                                        Small Business
                                        ...
                                        Buy Button
                                                                                    ...
                                                                                    <span class="link-description">Sell from blogs, emails, and more</span></a></li></ul></ul></div></div><div class="topBar-dropdown topBar-dropdown--6"><div class="topBar-dropdown-navSection topBar-dropdown-navSection--main "><ul class="topBar-dropdown-nav"><li class="topBar-dropdown-nav-item"><a href="/apps/" title="/apps/">
                                        App Store
                                        
                                                                                    <span class="link-description">Connect to leading software</span></a></li><li class="topBar-dropdown-nav-item"><a href="/theme-store/" title="/theme-store/">
                                        Theme Store
                                        
                                                                                    <span class="link-description">Beautiful design templates</span></a></li><li class="topBar-dropdown-nav-item"><a href="/partners/" title="/partners/">
                                        Partner Services
                                        
                                                                                    <span class="link-description">Get help building your store</span></a></li></ul><ul class="topBar-dropdown-nav"><li class="topBar-dropdown-nav-item"><a href="/case-study/" title="/case-study/">
                                        Case Studies
                                        
                                                                                    <span class="link-description">See our success stories</span></a></li><li class="topBar-dropdown-nav-item"><a href="/blog/" title="/blog/"target="_blank" >
                                        Ecommerce Blog
